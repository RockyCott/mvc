...
Revision ID: 3f03295114eb
Revises: 59c79a8b963a
Create Date: 2021-06-21 11:24:04.155040
...
revision = '3f03295114eb'
down_revision = '59c79a8b963a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.execute('ALTER TABLE communities.post DROP COLUMN community_id')
    ...
    op.execute('ALTER TABLE communities.comment DROP COLUMN post_id')
